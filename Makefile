...
#	$(CC) nsfork.o nsexec.o -o $@

nschroot: nsfork.o nschroot.o
	$(CC) $(LDFLAGS) nsfork.o nschroot.o -o $@

nslite: nsfork.o nslite_rpc.o nslite_rpc_parse.o nslite_rpc_gen.o nslite.o nslite_rpc.h
	$(CC) $(LDFLAGS) -lyajl nslite_rpc.o nslite_rpc_parse.o nslite_rpc_gen.o nsfork.o nslite.o -o $@

test_nslite_rpc_parse: nslite_rpc_parse.o test_nslite_rpc_parse.o nslite_rpc.h
	$(CC) $(LDFLAGS) -lyajl nslite_rpc_parse.o test_nslite_rpc_parse.o -o $@

clean:
	rm -f *.o nschroot nsexec nslite test_nslite_rpc_parse
